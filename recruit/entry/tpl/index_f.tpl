  ...
  <div class="form-nav">
	...
	<select name="birth_day" id="birth_day">
        ...
        <tr>
          ...
          <td>
            <input type="text" name="school_name" id="school_name" value="<?php echo htmlspecialchars($school_name); ?>">
	    <?php if( !empty($error['school_name']) ){ echo sprintf('<br /><span class="must_contact">%s</span>', $error['school_name']); } ?>
          </td>
        </tr>
        <tr>
          <th><span>必須</span>卒業/卒業見込み</th>
          <td>
            <input type="text" name="school_graduate" id="school_graduate" value="<?php echo htmlspecialchars($school_graduate); ?>">
	    <?php if( !empty($error['school_graduate']) ){ echo sprintf('<br /><span class="must_contact">%s</span>', $error['school_graduate']); } ?>
          </td>
        </tr>
        <tr>
