    ...
    <tr>
      ...
      <td>
        ...
        <tr>
          <th>部署</th>
          <td>
            <?php if( !empty($company_department) ){ echo htmlspecialchars($company_department); } ?>
            <input type="hidden" name="company_department" value="<?php echo htmlspecialchars($company_department); ?>">
          </td>
        </tr>
        <tr>
          <th>役職</th>
          <td>
            <?php if( !empty($company_position) ){ echo htmlspecialchars($company_position); } ?>
            <input type="hidden" name="company_position" value="<?php echo htmlspecialchars($company_position); ?>">
          </td>
        </tr>
        <tr>
